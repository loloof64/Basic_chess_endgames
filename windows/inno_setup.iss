...
AppId={{298FA273-E493-4642-872B-53707CC93BC1}
AppName={#MyAppName}
...
Source: "..\build\windows\x64\plugins\screen_retriever_windows\Release\*"; DestDir: "{app}\plugins\screen_retriever_windows\shared\Release"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\build\windows\x64\plugins\window_manager\Release\*"; DestDir: "{app}\plugins\window_manager\shared\Release"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "..\build\windows\x64\runner\Release\data\icudtl.dat"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\build\windows\x64\runner\Release\data\app.so"; DestDir: "{app}"; Flags: ignoreversion
